              ...
              <div class="navbar-right ">
                <ul class="nav navbar-nav">
                  ...
                  <li class="github-link mr-3">
                    <a class="btn btn-outline-secondary btn-sm" href="{{ asset('https://github.com/tafcoder/sleek-dashboard')}}" target="_blank">
                  ...
                  <li class="dropdown notifications-menu">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                      ...
                      <li class="dropdown-footer">
                        <a class="text-center" href="{{ asset('#')}}"> View All </a>
                      </li>
                    </ul>
                  </li>
                  <!-- User Account -->
                  <li class="dropdown user-menu">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                      ...
                      <li>
                        <a href="{{ asset('#')}}"> <i class="mdi mdi-diamond-stone"></i> Projects </a>
                      </li>
                      <li>
                        <a href="{{ asset('#')}}"> <i class="mdi mdi-settings"></i> Account Setting </a>
                      </li>
...
@yield('admin')
            ...
            <div class="copyright bg-white">
              <p>
                ...
                <a
                  class="text-primary"
                  href="{{ asset('http://www.iamabdus.com/')}}"
                  target="_blank"
                  >Abdus</a
                >.
              </p>
