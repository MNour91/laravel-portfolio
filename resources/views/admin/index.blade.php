  ...
  @section('admin')
    ...
    <div class="card card-default" data-scroll-height="675">
        ...
        <a href="{{ asset('#')}}" class="pb-5 d-block text-center text-muted"><i class="mdi mdi-download mr-2"></i> Download overall report</a>
        <div class="card-footer d-flex flex-wrap bg-white p-0">
        <div class="col-6">
            <div class="py-4 px-4">
    ...
    <div class="card card-default">
        ...
        <ul class="nav nav-pills mb-5 mt-5 nav-style-fill nav-justified" id="pills-tab" role="tablist">
            <li class="nav-item">
            <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="{{ asset('#pills-home')}}" role="tab" aria-controls="pills-home" aria-selected="true">Sales Status</a>
            </li>
            <li class="nav-item">
            <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="{{ asset('#pills-profile')}}" role="tab" aria-controls="pills-profile" aria-selected="false">Monthly Sales</a>
            </li>
        </ul>
    ...
    <div class="card card-table-border-none" data-scroll-height="550">
        ...
        <div>
            ...
            <div class="dropdown show d-inline-block widget-dropdown">
                <a class="dropdown-toggle icon-burger-mini" href="{{ asset('#')}}" role="button" id="dropdown-units" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-display="static"></a>
                <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-units">
                    <li class="dropdown-item"><a  href="{{ asset('#')}}">Action</a></li>
                    <li class="dropdown-item"><a  href="{{ asset('#')}}">Another action</a></li>
                    <li class="dropdown-item"><a  href="{{ asset('#')}}">Something else here</a></li>
                </ul>
                </div>
        </div>
        </div>
        ...
        <a href="{{ asset('#')}}" class="btn-link py-3 text-uppercase">View Report</a>
        </div>
    </div>
    </div>
            ...
            <div class="card-header justify-content-between ">
                ...
                <div>
                    <button class="text-black-50 mr-2 font-size-20"><i class="mdi mdi-cached"></i></button>
                    <div class="dropdown show d-inline-block widget-dropdown">
                        <a class="dropdown-toggle icon-burger-mini" href="{{ asset('#')}}" role="button" id="dropdown-notification" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-display="static"></a>
            ...
            <div class="card-body slim-scroll">
                ...
                <div class="media-body pr-3 ">
                    <a class="mt-0 mb-1 font-size-15 text-dark" href="{{ asset('#')}}">New Order</a>
                ...
                <div class="media-body pr-3">
                    <a class="mt-0 mb-1 font-size-15 text-dark" href="{{ asset('#')}}">New Enquiry</a>
                ...
                <div class="media-body pr-3">
                    <a class="mt-0 mb-1 font-size-15 text-dark" href="{{ asset('#')}}">Support Ticket</a>
                ...
                <div class="media-body pr-3">
                    <a class="mt-0 mb-1 font-size-15 text-dark" href="{{ asset('')}}">Comapny Meetup</a>
                    <p >Phileine has placed an new order</p>
                </div>
                <span class=" font-size-12 d-inline-block"><i class="mdi mdi-clock-outline"></i> 10 AM</span>
                </div>
    ...
    <div class="card card-table-border-none" id="recent-orders">
        ...
        <table class="table card-table table-responsive table-responsive-large" style="width:100%">
            ...
            <tr>
                <td >24541</td>
                <td >
                <a class="text-dark" href="{{ asset('')}}"> Coach Swagger</a>
                </td>
                ...
                <td class="text-right">
                <div class="dropdown show d-inline-block widget-dropdown">
                    <a class="dropdown-toggle icon-burger-mini" href="{{ asset('')}}" role="button" id="dropdown-recent-order1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-display="static"></a>
                    <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-recent-order1">
                    <li class="dropdown-item">
                        <a href="{{ asset('#')}}">View</a>
                    </li>
                    <li class="dropdown-item">
                        <a href="{{ asset('#')}}">Remove</a>
                    </li>
                    </ul>
                </div>
                </td>
            ...
            <tr>
                <td >24541</td>
                <td >
                <a class="text-dark" href="{{ asset('')}}"> Toddler Shoes, Gucci Watch</a>
                </td>
                ...
                <td class="text-right">
                <div class="dropdown show d-inline-block widget-dropdown">
                    <a class="dropdown-toggle icon-burger-mini" href="{{ asset('#')}}" role="button" id="dropdown-recent-order2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-display="static"></a>
            ...
            <tr>
                <td >24541</td>
                <td >
                <a class="text-dark" href="{{ asset('')}}"> Hat Black Suits</a>
                </td>
                <td class="d-none d-md-table-cell">1 Unit</td>
                ...
                <td class="text-right">
                <div class="dropdown show d-inline-block widget-dropdown">
                    <a class="dropdown-toggle icon-burger-mini" href="{{ asset('#')}}" role="button" id="dropdown-recent-order3" data-toggle="dropdown" aria-haspopup="true"
            ...
            <tr>
                <td >24541</td>
                <td >
                <a class="text-dark" href="{{ asset('')}}"> Backpack Gents, Swimming Cap Slin</a>
                </td>
                ...
                <td class="text-right">
                <div class="dropdown show d-inline-block widget-dropdown">
                    <a class="dropdown-toggle icon-burger-mini" href="{{ asset('#')}}" role="button" id="dropdown-recent-order4" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-display="static"></a>
            ...
            <tr>
                <td >24541</td>
                <td >
                <a class="text-dark" href="{{ asset('')}}"> Speed 500 Ignite</a>
                </td>
                <td class="d-none d-md-table-cell">1 Unit</td>
                ...
                <td class="text-right">
                <div class="dropdown show d-inline-block widget-dropdown">
                    <a class="dropdown-toggle icon-burger-mini" href="{{ asset('#')}}" role="button" id="dropdown-recent-order5" data-toggle="dropdown" aria-haspopup="true"
                    aria-expanded="false" data-display="static"></a>
    ...
    <div class="card card-default todo-table" id="todo" data-scroll-height="550">
        <div class="card-header justify-content-between">
        <h2>To Do List</h2>
        <a class="btn btn-primary btn-pill" id="add-task" href="{{ asset('#')}}" role="button"> Add task </a>
        </div>
        <div class="card-body slim-scroll">
    ...
    <div class="card card-default" >
        ...
        <div class="dropdown show d-inline-block widget-dropdown ml-auto">
            <a class="dropdown-toggle" href="{{ asset('#')}}" role="button" id="world-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-display="static">
            World Wide
            </a>
            <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="world-dropdown">
            <li class="dropdown-item"><a href="{{ asset('#')}}">Continetal chart</a></li>
            <li class="dropdown-item"><a href="{{ asset('#')}}">Sub-continental</a></li>
            </ul>
        </div>
        </div>
    ...
    <div class="card card-table-border-none"  data-scroll-height="580">
        ...
        <div>
            ...
            <div class="dropdown show d-inline-block widget-dropdown">
                <a class="dropdown-toggle icon-burger-mini" href="{{ asset('#')}}" role="button" id="dropdown-customar"  data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-display="static">
                </a>
        ...
        <table class="table ">
            ...
            <tr>
                ...
                <div class="media">
                    ...
                    <a href="{{ asset('profile.html')}}"><img class="rounded-circle w-45" src="{{  asset('backendassets/img/user/u1.jpg')}}" alt="customer image"></a>
                    </div>
                    <div class="media-body align-self-center">
                    <a href="{{ asset('profile.html')}}"><h6 class="mt-0 text-dark font-weight-medium">Selena Wagner</h6></a>
            ...
            <tr>
                ...
                <div class="media">
                    <div class="media-image mr-3 rounded-circle">
                    <a href="{{ asset('profile.html')}}"><img class="rounded-circle w-45" src="{{  asset('backendassets/img/user/u2.jpg')}}" alt="customer image"></a>
                    </div>
                    <div class="media-body align-self-center">
                    <a href="{{ asset('profile.html')}}"><h6 class="mt-0 text-dark font-weight-medium">Walter Reuter</h6></a>
            ...
            <tr>
                ...
                <div class="media">
                    <div class="media-image mr-3 rounded-circle">
                    <a href="{{ asset('profile.html')}}"><img class="rounded-circle w-45" src="{{  asset('backendassets/img/user/u3.jpg')}}" alt="customer image"></a>
                    </div>
                    <div class="media-body align-self-center">
                    <a href="{{ asset('profile.html')}}"><h6 class="mt-0 text-dark font-weight-medium">Larissa Gebhardt</h6></a>
            ...
            <tr>
                ...
                <div class="media">
                    <div class="media-image mr-3 rounded-circle">
                    <a href="{{ asset('profile.html')}}"><img class="rounded-circle w-45" src="{{  asset('backendassets/img/user/u4.jpg')}}" alt="customer image"></a>
                    </div>
                    <div class="media-body align-self-center">
                    <a href="{{ asset('profile.html')}}"><h6 class="mt-0 text-dark font-weight-medium">Albrecht Straub</h6></a>
            ...
            <tr>
                ...
                <div class="media">
                    <div class="media-image mr-3 rounded-circle">
                    <a href="{{ asset('profile.html')}}"><img class="rounded-circle w-45" src="{{  asset('backendassets/img/user/u5.jpg')}}" alt="customer image"></a>
                    </div>
                    <div class="media-body align-self-center">
                    <a href="{{ asset('profile.html')}}"><h6 class="mt-0 text-dark font-weight-medium">Leopold Ebert</h6></a>
    ...
    <div class="card card-default" data-scroll-height="580">
        ...
        <div>
            <button class="text-black-50 mr-2 font-size-20"><i class="mdi mdi-cached"></i></button>
            <div class="dropdown show d-inline-block widget-dropdown">
                <a class="dropdown-toggle icon-burger-mini" href="{{ asset('#')}}" role="button" id="dropdown-product" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-display="static">
                </a>
                <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-product">
                    <li class="dropdown-item"><a  href="{{ asset('#')}}">Update Data</a></li>
                    <li class="dropdown-item"><a  href="{{ asset('#')}}">Detailed Log</a></li>
                    <li class="dropdown-item"><a  href="{{ asset('#')}}">Statistics</a></li>
                    <li class="dropdown-item"><a  href="{{ asset('#')}}">Clear Data</a></li>
                </ul>
                </div>
        </div>
        ...
        <div class="media d-flex mb-5">
            ...
            <a href="{{ asset('#')}}"><img src="{{  asset('backendassets/img/products/p1.jpg')}}" alt="customer image"></a>
            </div>
            <div class="media-body align-self-center">
            <a href="{{ asset('#')}}"><h6 class="mb-3 text-dark font-weight-medium"> Coach Swagger</h6></a>
        ...
        <div class="media d-flex mb-5">
            <div class="media-image align-self-center mr-3 rounded">
            <a href="{{ asset('#')}}"><img src="{{  asset('backendassets/img/products/p2.jpg')}}" alt="customer image"></a>
            </div>
            <div class="media-body align-self-center">
            <a href="{{ asset('#')}}"><h6 class="mb-3 text-dark font-weight-medium"> Coach Swagger</h6></a>
            <p class="float-md-right"><span class="text-dark mr-2">20</span>Sales</p>
        ...
        <div class="media d-flex mb-5">
            <div class="media-image align-self-center mr-3 rounded">
            <a href="{{ asset('#')}}"><img src="{{  asset('backendassets/img/products/p3.jpg')}}" alt="customer image"></a>
            </div>
            <div class="media-body align-self-center">
            <a href="{{ asset('#')}}"><h6 class="mb-3 text-dark font-weight-medium"> Gucci Watch</h6></a>
